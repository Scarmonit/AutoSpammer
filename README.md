...
<!-- DOWNLOAD BUTTONS -->
<p align="center">
  <a href="https://github.com/Scarmonit/AutoSpammer/releases/latest/download/AutoSpammer-Portable-1.36.0.exe">
...
| --- | --- | --- |
| **Portable** | Easiest — just run it. Nothing is installed. | **[AutoSpammer-Portable-1.36.0.exe](https://github.com/Scarmonit/AutoSpammer/releases/latest/download/AutoSpammer-Portable-1.36.0.exe)** |
| **Installer** | Adds Desktop and Start-menu shortcuts. | **[AutoSpammer-Setup-1.36.0.exe](https://github.com/Scarmonit/AutoSpammer/releases/latest/download/AutoSpammer-Setup-1.36.0.exe)** |
